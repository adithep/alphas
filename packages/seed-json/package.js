...
Package.on_use(function (api, where, asset) {
  ...
  api.add_files(['keys.json', 'schema_keys.json', 'schema.json', 'tags.json', 'currencies.json', 'countries.json', 'cities.json', 'services.json', 'titles.json'], 'server', {isAsset: true});
